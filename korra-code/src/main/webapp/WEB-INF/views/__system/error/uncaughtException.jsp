		...
		<div id="errorcon">
			<div class="noconnect">
				<div class="noconnectcon">
					...
					<p class="desc02">지속적인 문제가 발생하면, 고객센터 : <strong>1588 – 0000</strong><br />또는 E-mail : <span><a href="mailto:help@domain.com">mailto:help@domain.com</a></span> 로 연락 주시기 바랍니다.</p>
				</div>
			</div>
		</div>
	</div>

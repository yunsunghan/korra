...
import com.ks.code.account.domain.AccountDataOnDemand;
...
privileged aspect AccountIntegrationTest_Roo_IntegrationTest {
    ...
    public void AccountIntegrationTest.testCountAccounts() {
        ...
        long count = com.ks.code.account.domain.Account.countAccounts();
    ...
    public void AccountIntegrationTest.testFindAccount() {
        com.ks.code.account.domain.Account obj = dod.getRandomAccount();
        ...
        obj = com.ks.code.account.domain.Account.findAccount(id);
    ...
    public void AccountIntegrationTest.testFindAllAccounts() {
        ...
        java.util.List<com.ks.code.account.domain.Account> result = com.ks.code.account.domain.Account.findAllAccounts();
    ...
    public void AccountIntegrationTest.testFindAccountEntries() {
        ...
        java.util.List<com.ks.code.account.domain.Account> result = com.ks.code.account.domain.Account.findAccountEntries(0, (int) count);
    ...
    public void AccountIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyAccount(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.ks.code.account.domain.Account merged =  obj.merge();
        obj.flush();
    ...
    public void AccountIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Account' failed to initialize correctly", dod.getRandomAccount());
        com.ks.code.account.domain.Account obj = dod.getNewTransientAccount(Integer.MAX_VALUE);
    ...
    public void AccountIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Account' with identifier '" + id + "'", com.ks.code.account.domain.Account.findAccount(id));
    }

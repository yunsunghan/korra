...
<c:url value="/backoffice/codecreators/update" var="form_url"></c:url>
...
<th colspan="2">CodeFormat:</th><td>
${codecreator.codeFormat}
</td>
</tr>
<!--fields : barcodeformat-->
<tr id="roo_codeFiles">
<th colspan="2">CodeFiles:</th><td>
